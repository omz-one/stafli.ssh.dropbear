#
#    Stafli Dropbear SSH Server (Makefile)
...
purge:
	...
	@echo
		...
		bash -c "(cd debian8; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.ssh.dropbear:dropbear2014_debian8;
		@echo
		@echo Purging containers, networks, volumes and images for debian7...
		bash -c "(cd debian7; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.ssh.dropbear:dropbear2012_debian7;
		@echo
		@echo Purging containers, networks, volumes and images for centos7...
		bash -c "(cd centos7; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.ssh.dropbear:dropbear2017_centos7;
		@echo
		@echo Purging containers, networks, volumes and images for centos6...
		bash -c "(cd centos6; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.ssh.dropbear:dropbear2017_centos6;
        else
		@echo Purging containers, networks, volumes and images for $(DISTRO)...
		bash -c "(cd $(DISTRO); set -o allexport; source .env; set +o allexport; docker-compose down)";
                ifeq ($(DISTRO), debian8)
			docker image rm stafli/stafli.ssh.dropbear:dropbear2014_$(DISTRO);
                else ifeq ($(DISTRO), debian7)
			docker image rm stafli/stafli.ssh.dropbear:dropbear2012_$(DISTRO);
                else ifeq ($(DISTRO), centos7)
			docker image rm stafli/stafli.ssh.dropbear:dropbear2017_$(DISTRO);
...
img-ls:
	...
	@echo
		...
		docker image ls | grep -E "stafli/stafli.ssh.dropbear.*debian8" | sort -n;
		@echo
		@echo Listing images for debian7...
		docker image ls | grep -E "stafli/stafli.ssh.dropbear.*debian7" | sort -n;
		@echo
		@echo Listing images for centos7...
		docker image ls | grep -E "stafli/stafli.ssh.dropbear.*centos7" | sort -n;
		@echo
		@echo Listing images for centos6...
		docker image ls | grep -E "stafli/stafli.ssh.dropbear.*centos6" | sort -n;
        else
		@echo Listing images for $(DISTRO)...
		docker image ls | grep -E "stafli/stafli.ssh.dropbear.*$(DISTRO)" | sort -n;
        endif
...
con-inspect:
	...
	@echo
		...
		docker container inspect stafli_ssh_dropbear2014_debian8_1;
		@echo
		@echo Inspecting containers for debian7...
		docker container inspect stafli_ssh_dropbear2012_debian7_1;
		@echo
		@echo Inspecting containers for centos7...
		docker container inspect stafli_ssh_dropbear2017_centos7_1;
		@echo
		@echo Inspecting containers for centos6...
		docker container inspect stafli_ssh_dropbear2017_centos6_1;
        else
		@echo Inspecting containers for $(DISTRO)...
                ifeq ($(DISTRO), debian8)
			docker container inspect stafli_ssh_dropbear2014_$(DISTRO)_1;
                else ifeq ($(DISTRO), debian7)
			docker container inspect stafli_ssh_dropbear2012_$(DISTRO)_1;
                else ifeq ($(DISTRO), centos7)
			docker container inspect stafli_ssh_dropbear2017_$(DISTRO)_1;
                else ifeq ($(DISTRO), centos6)
			docker container inspect stafli_ssh_dropbear2017_$(DISTRO)_1;
                endif
        endif
...
con-ips:
	...
	@echo
		...
		docker container inspect stafli_ssh_dropbear2014_debian8_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for debian7...
		docker container inspect stafli_ssh_dropbear2012_debian7_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos7...
		docker container inspect stafli_ssh_dropbear2017_centos7_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos6...
		docker container inspect stafli_ssh_dropbear2017_centos6_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        else
...
con-ports:
	...
	@echo
		...
		docker container port stafli_ssh_dropbear2014_debian8_1;
		@echo
		@echo Showing ports of containers for debian7...
		docker container port stafli_ssh_dropbear2012_debian7_1;
		@echo
		@echo Showing ports of containers for centos7...
		docker container port stafli_ssh_dropbear2017_centos7_1;
		@echo
		@echo Showing ports of containers for centos6...
		docker container port stafli_ssh_dropbear2017_centos6_1;
        else
		@echo Showing ports of containers for $(DISTRO)...
                ifeq ($(DISTRO), debian8)
			docker container port stafli_ssh_dropbear2014_$(DISTRO)_1;
                else ifeq ($(DISTRO), debian7)
			docker container port stafli_ssh_dropbear2012_$(DISTRO)_1;
                else ifeq ($(DISTRO), centos7)
			docker container port stafli_ssh_dropbear2017_$(DISTRO)_1;
                else ifeq ($(DISTRO), centos6)
			docker container port stafli_ssh_dropbear2017_$(DISTRO)_1;
                endif
        endif
...
con-top:
	...
	@echo
		...
		docker container top stafli_ssh_dropbear2014_debian8_1;
		@echo
		@echo Showing processes of containers for debian7...
		docker container top stafli_ssh_dropbear2012_debian7_1;
		@echo
		@echo Showing processes of containers for centos7...
		docker container top stafli_ssh_dropbear2017_centos7_1;
		@echo
		@echo Showing processes of containers for centos6...
		docker container top stafli_ssh_dropbear2017_centos6_1;
        else
		@echo Showing processes of containers for $(DISTRO)...
                ifeq ($(DISTRO), debian8)
			docker container top stafli_ssh_dropbear2014_$(DISTRO)_1;
                else ifeq ($(DISTRO), debian7)
			docker container top stafli_ssh_dropbear2012_$(DISTRO)_1;
                else ifeq ($(DISTRO), centos7)
			docker container top stafli_ssh_dropbear2017_$(DISTRO)_1;
                else ifeq ($(DISTRO), centos6)
			docker container top stafli_ssh_dropbear2017_$(DISTRO)_1;
                endif
        endif
